...
var RecyclerViewComponent = function (props, ref) {
    ...
    var _c = tslib_1.__read((0, react_1.useState)(true), 2), isAtBottom = _c[0], setIsAtBottom = _c[1];
    ...
    var _d = tslib_1.__read((0, useLayoutState_1.useLayoutState)(0), 2), _ = _d[0], setLayoutTreeId = _d[1];
    var _e = tslib_1.__read((0, react_1.useState)(0), 2), __ = _e[0], setRenderId = _e[1];
    ...
    var _f = (0, useRecyclerViewManager_1.useRecyclerViewManager)(props), recyclerViewManager = _f.recyclerViewManager, velocityTracker = _f.velocityTracker;
    var _g = (0, useRecyclerViewController_1.useRecyclerViewController)(recyclerViewManager, ref, scrollViewRef, scrollAnchorRef), applyOffsetCorrection = _g.applyOffsetCorrection, computeFirstVisibleIndexForOffsetCorrection = _g.computeFirstVisibleIndexForOffsetCorrection, applyInitialScrollIndex = _g.applyInitialScrollIndex, handlerMethods = _g.handlerMethods;
    ...
    var onScrollHandler = (0, react_1.useCallback)(function (event) {
        ...
        var _f = event.nativeEvent, contentOffset = _f.contentOffset, layoutMeasurement = _f.layoutMeasurement, contentSize = _f.contentSize;
        var paddingToBottom = 20; // px tolerance
        var isNowAtBottom = contentOffset.y + layoutMeasurement.height >=
            contentSize.height - paddingToBottom;
        setIsAtBottom(isNowAtBottom);
        (_e = (_d = recyclerViewManager.props).onScroll) === null || _e === void 0 ? void 0 : _e.call(_d, event);
    }, [
        checkBounds,
        computeFirstVisibleIndexForOffsetCorrection,
        horizontal,
    ...
    var _h = (0, useSecondaryProps_1.useSecondaryProps)(props), refreshControl = _h.refreshControl, renderHeader = _h.renderHeader, renderFooter = _h.renderFooter, renderEmpty = _h.renderEmpty, CompatScrollView = _h.CompatScrollView;
                ...
                react_1.default.createElement(ViewHolderCollection_1.ViewHolderCollection, { viewHolderCollectionRef: viewHolderCollectionRef, data: data, horizontal: horizontal, renderStack: recyclerViewManager.getRenderStack(), getLayout: function (index) { return recyclerViewManager.getLayout(index); }, getAdjustmentMargin: function () {
                        ...
                        if (recyclerViewManager.hasLayout() && isAtBottom) {
                            ...
                            var contentSize = horizontal
                                ? recyclerViewManager.getChildContainerDimensions().width
                                : recyclerViewManager.getChildContainerDimensions().height;
                            var offset = Math.max(0, contentSize - containerSize);
                            (_a = scrollViewRef === null || scrollViewRef === void 0 ? void 0 : scrollViewRef.current) === null || _a === void 0 ? void 0 : _a.scrollTo({ y: offset, animated: true });
                        }
